...
public class SnowFlake {
    ...
    public static long parseTimestampFromSnowFlakeId(long id) {
        return (id >> SnowFlake.TIMESTMP_LEFT) + SnowFlake.START_STMP;
    }
    ...
    public static class SnowFlakeId {
        ...
        public SnowFlakeId(long id, long timeStart) {
            this.id = id;
            this.timeStart = timeStart;

            long timeGap = (id >> SnowFlake.TIMESTMP_LEFT);
            this.timestamp = timeGap + SnowFlake.START_STMP;

            long segment1 = (id ^ (timeGap << SnowFlake.TIMESTMP_LEFT));
            this.dataCenterId = segment1 >> SnowFlake.DATACENTER_LEFT;

            long segment2 = (segment1 ^ (dataCenterId << SnowFlake.DATACENTER_LEFT));
            this.machineId = segment2 >> SnowFlake.MACHINE_LEFT;

            this.sequence = segment2 ^ (machineId << SnowFlake.MACHINE_LEFT);
        }
